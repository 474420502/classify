...
// 	c := New[*Item]()
// 	c.AddCategory("region", func(value *Item) interface{} {
// 		item := value
// 		return item.Region
// 	}).AddCategory("country", func(value *Item) interface{} {
// 		item := value
// 		return item.Country
// 	}).Collect()
...
// 		func(value *GiftItem) interface{} {
// 			return value.RFC
// 		},
// 		func(value *GiftItem) interface{} {
// 			return value.RegionRFC
// 		},
// 	)
...
// 	clsfy := NewWithMode[*GiftItem](`region<RegionRFC>.country<RFC>.@Coin`)
// 	items := loadGiftItems()
